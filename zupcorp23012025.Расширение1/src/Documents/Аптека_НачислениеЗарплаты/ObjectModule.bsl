...
Процедура ОбработкаПроведения(Отказ, Режим)
	...
	Для Каждого ТекСтрокаТЧАптека Из ТЧАптека Цикл
		...
		Движение.БонусЗаОптику=ТекСтрокаТЧАптека.БонусЗаОптику;
		...
		Движение.ПремияЗаКатегориюСтоимость=ТекСтрокаТЧАптека.ПремияЗаКатегориюСтоимость;
		...
		Движение.ПремияНочнаяСтоимость=ТекСтрокаТЧАптека.ПремияНочнаяСтоимость;
		Движение.ПремияНочнаяСумма=ТекСтрокаТЧАптека.ПремияНочнаяСумма;
		Движение.Уволен=ТекСтрокаТЧАптека.Уволенная;
		
		Движение.КолПринятыхЗвонков=ТекСтрокаТЧАптека.КолПринятыхЗвонков;
		Движение.БонусЗвонки=ТекСтрокаТЧАптека.ПремияЗвонки;
		Движение.КолСобранныхУпаковок=ТекСтрокаТЧАптека.КолСобранныхУпаковок;
		Движение.БонусСтрокиЗаказов=ТекСтрокаТЧАптека.ПремияУпаковки;
